...
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "2348060834756";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "2348060834756";
...
module.exports = {
  ...
  packname: process.env.PACK_NAME || "ALONEKID",
  botname : process.env.BOT_NAME  || "ALONEKID-ᴍᴅ",
  ownername:process.env.OWNER_NAME|| "ALONEKID",
